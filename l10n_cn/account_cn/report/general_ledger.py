...
report_sxw.report_sxw('report.account.general_ledger', 'account.account', 'addons/l10n_cn/account_cn/report/general_ledger.odt', parser=general_ledger_parser, header=False)
