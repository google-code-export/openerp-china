...
#现金日记帐
report_sxw.report_sxw('report.account.cash_ledger', 'account.account', 'addons/l10n_cn/account_cn/report/cash_ledger.odt', parser=CashLedgerParser, header=False)

#外币日记帐
report_sxw.report_sxw('report.account.foreign_currency_cash_ledger', 'account.account', 'addons/l10n_cn/account_cn/report/foreign_currency_cash_ledger.odt', parser=CashLedgerParser, header=False)

#三栏明细帐
report_sxw.report_sxw('report.account.threecolumns_ledger', 'account.account', 'addons/l10n_cn/account_cn/report/threecolumns_ledger.odt', parser=LedgerParser, header=False)
        
#数量金额明细帐
report_sxw.report_sxw('report.account.product_ledger', 'account.account', 'addons/l10n_cn/account_cn/report/product_ledger.odt', parser=LedgerParser, header=False)
